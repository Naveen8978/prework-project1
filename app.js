...
function move(num,dir){
    let temp;
    switch(dir){
        case 'E':temp = queen.position.y+num;
        if(temp>8 || temp<0){
        ...
        break;
        case 'S':temp = queen.position.y+num;
        if(temp>8 || temp<0){
        console.log("Outside Boundary");
        document.write("Outside Boundary");
        }
        ...
        break;
        case 'N':temp = queen.position.x-num;
        if(temp>8 || temp<0){
        console.log("Outside Boundary");
        document.write("Outside Boundary");
        }
        ...
        break;
        case 'SE':temp = queen.position.x+num;
        ...
        break;
        case 'SW':temp = queen.position.x+num;
        temp1=queen.position.y-num;
        if(temp>8 || temp<0){
        console.log("Outside Boundary");
        document.write("Outside Boundary");
        ...
        break;
        case 'NE':temp = queen.position. x-num;
        temp1=queen.position.y+num;
        if(temp>8 || temp<0){
        console.log("Outside Boundary");
        document.write("Outside Boundary");
        ...
        break;
        case 'NW':temp = queen.position.x-num;
        temp1=queen.position.y-num;
        if(temp>8 || temp<0){
        console.log("Outside Boundary");
        document.write("Outside Boundary");
...
function play(){
    ...
    value.forEach(element => {
        ...
        let dir = element.slice(0,elemenbt.length-1);
        move(num,dir);
    })
